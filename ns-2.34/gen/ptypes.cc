...
set ptype(nrr) 62\n\
set pvals(62) NRR\n\
set ptype(nrrrouting) 63\n\
set pvals(63) NRRRouting\n\
set ptype(charging) 64\n\
set pvals(64) Charging\n\
set ptype(chargingrt) 65\n\
set pvals(65) ChargingRT\n\
set ptype(rilagent) 66\n\
set pvals(66) RILAgent\n\
set ptype(gpsr) 67\n\
set pvals(67) GPSR\n\
proc ptype2val {str} {\n\
global ptype\n\
